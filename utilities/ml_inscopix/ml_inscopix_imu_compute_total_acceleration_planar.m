function [regular_timestamps_s, regular_ax, regular_ay, regular_az, regular_totalAcceleration, imuFs] = ml_inscopix_imu_compute_total_acceleration_planar( imuData )
    ...
    % Z is not used.
    regular_totalAcceleration = sqrt( regular_ax.^2 + regular_ay.^2);    
end % function