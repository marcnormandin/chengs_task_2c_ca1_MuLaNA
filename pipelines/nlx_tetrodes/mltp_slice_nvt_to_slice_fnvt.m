function mltp_slice_nvt_to_slice_fnvt(obj, session)
            ...
            for iSlice = 1:length(nvtFilenames)
                ...
                [animal_facing_angle_deg] = ml_clean_headdirection_data(s.extractedAngle, s.timeStamps_mus, false);
                interpAngle = animal_facing_angle_deg;
                
                % Now do the new fixer upper
